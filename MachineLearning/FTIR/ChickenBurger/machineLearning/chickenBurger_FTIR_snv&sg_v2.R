...
# xlsx files
df <- read_excel("chickenBurger_FTIR_snv&sg_v2.xlsx")
dfA <- read_excel("chickenBurger_FTIR_snv&sg_batchA.xlsx")
dfB <- read_excel("chickenBurger_FTIR_snv&sg_batchB.xlsx")
...
set.seed(123)
# create specra dataframe
spectraA_2 <- dfA[,5:2999]
spectraB_2 <- dfB[,5:2999]
#calculate correlation matrix
...
saveRDS(predictors_tsa_toSave, "./models/CB/FTIR/predictors_RF_TVC.rds") #save model as an rds object
...
RMSE.Rf_TSA1 <- RMSE(test_tsa2$TSA,pred_Rf_TSA1) #RMSE =0.51
...
ci.Rf_TSA <- CI(rmse.Rf_TSA.vector, ci = 0.95) #package: Rmisc #0.51, 0.49, 0.47 
# rmse mean
rmse.Rf_TSA.mean <- round(mean(rmse.Rf_TSA.vector), digits = 2) #0.49
...
RMSE.Rf_TSA2 <- RMSE(dfB2_TSA$TSA,pred_Rf_TSA2) #RMSE =1.45
...
RMSE.knn_TSA1 <- RMSE(test_tsa2$TSA,pred_knn_TSA1) #RMSE =0.76
...
# find the 95% confidence intervals parameters
ci.knn_TSA <- CI(rmse.knn_TSA.vector, ci = 0.95) # 0.64, 0.61, 0.59
# rmse mean
rmse.knn_TSA.mean <- round(mean(rmse.knn_TSA.vector), digits = 2) #0.61
...
RMSE.knn_TSA2 <- RMSE(dfB2_TSA$TSA,pred_knn_TSA2) #RMSE =1.5
...
RMSE.SVMLM_TSA1 <- RMSE(test_tsa2$TSA,pred_SVMLM_TSA1) #RMSE =0.62
...
# find the 95% confidence intervals parameters
ci.SVMLM_TSA <- CI(rmse.SVMLM_TSA.vector, ci = 0.95) # 0.53, 0.51, 0.5  
# rmse mean
rmse.SVMLM_TSA.mean <- round(mean(rmse.SVMLM_TSA.vector), digits = 2) #0.51
...
RMSE.SVMLM_TSA2 <- RMSE(dfB2_TSA$TSA,pred_SVMLM_TSA2) #RMSE =41.33
...
RMSE.SVMR_TSA1 <- RMSE(test_tsa2$TSA,pred_SVMR_TSA1) #RMSE =0.51
...
# compute the standard deviation
sd.SVMR_TSA <- round(sd(rmse.SVMR_TSA.vector), digits = 2) #0.05
# find the 95% confidence intervals parameters
ci.SVMR_TSA <- CI(rmse.SVMR_TSA.vector, ci = 0.95) # 0.43, 0.42, 0.4   
# rmse mean
...
RMSE.SVMR_TSA2 <- RMSE(dfB2_TSA$TSA,pred_SVMR_TSA2) #RMSE =1.23
...
RMSE.SVMP_TSA1 <- RMSE(test_tsa2$TSA,pred_SVMP_TSA1) #RMSE =0.46
...
# compute the standard deviation
sd.SVMP_TSA <- round(sd(rmse.SVMP_TSA.vector), digits = 2) #0.48
# find the 95% confidence intervals parameters
ci.SVMP_TSA <- CI(rmse.SVMP_TSA.vector, ci = 0.95) # 0.76, 0.62, 0.49
# rmse mean
rmse.SVMP_TSA.mean <- round(mean(rmse.SVMP_TSA.vector), digits = 2) #0.62
...
RMSE.SVMP_TSA2 <- RMSE(dfB2_TSA$TSA,pred_SVMP_TSA2) #RMSE =12.42
...
RMSE.lm_TSA1 <- RMSE(test_tsa2$TSA,pred_lm_TSA1) #RMSE =0.59
...
# compute the standard deviation
sd.lm_TSA <- round(sd(rmse.lm_TSA.vector), digits = 2) #0.06
# find the 95% confidence intervals parameters
ci.lm_TSA <- CI(rmse.lm_TSA.vector, ci = 0.95) #package: Rmisc #0.51, 0.5, 0.48
# rmse mean
rmse.lm_TSA.mean <- round(mean(rmse.lm_TSA.vector), digits = 2) #0.5
...
RMSE.lm_TSA2 <- RMSE(dfB2_TSA$TSA,pred_lm_TSA2) #RMSE =32.33
...
saveRDS(predictors_cfc_toSave, "./models/CB/FTIR/predictors_RF_PS.rds") #save model as an rds object
...
RMSE.Rf_CFC1 <- RMSE(test_cfc2$CFC,pred_Rf_CFC1) #RMSE =0.51
accuracy_Rf_CFC <- accuracy(pred_Rf_CFC1, test_cfc2$CFC) #86.84
...
# find the 95% confidence intervals parameters
ci.Rf_CFC <- CI(rmse.Rf_CFC.vector, ci = 0.95) #package: Rmisc #0.6, 0.58, 0.55
# rmse mean
rmse.Rf_CFC.mean <- round(mean(rmse.Rf_CFC.vector), digits = 2) #0.58
...
RMSE.Rf_CFC2 <- RMSE(dfB2_CFC$CFC,pred_Rf_CFC2) #RMSE =1.7
...
RMSE.knn_CFC1 <- RMSE(test_cfc2$CFC,pred_knn_CFC1) #RMSE =0.81
...
# compute the standard deviation
sd.knn_CFC <- round(sd(rmse.knn_CFC.vector), digits = 2) #0.1
# find the 95% confidence intervals parameters
ci.knn_CFC <- CI(rmse.knn_CFC.vector, ci = 0.95) # 0.67, 0.64, 0.62
# rmse mean
rmse.knn_CFC.mean <- round(mean(rmse.knn_CFC.vector), digits = 2) #0.64
...
RMSE.knn_CFC2 <- RMSE(dfB2_CFC$CFC,pred_knn_CFC2) #RMSE =1.48
...
RMSE.SVMLM_CFC1 <- RMSE(test_cfc2$CFC,pred_SVMLM_CFC1) #RMSE =0.6
...
# find the 95% confidence intervals parameters
ci.SVMLM_CFC <- CI(rmse.SVMLM_CFC.vector, ci = 0.95) # 0.63, 0.61, 0.59  
# rmse mean
rmse.SVMLM_CFC.mean <- round(mean(rmse.SVMLM_CFC.vector), digits = 2) #0.61
...
RMSE.SVMLM_CFC2 <- RMSE(dfB2_CFC$CFC,pred_SVMLM_CFC2) #RMSE =33.85
...
RMSE.SVMR_CFC1 <- RMSE(test_cfc2$CFC,pred_SVMR_CFC1) #RMSE =0.63
...
# compute the standard deviation
sd.SVMR_CFC <- round(sd(rmse.SVMR_CFC.vector), digits = 2) #0.07
# find the 95% confidence intervals parameters
ci.SVMR_CFC <- CI(rmse.SVMR_CFC.vector, ci = 0.95) # 0.54, 0.52, 0.5   
# rmse mean
rmse.SVMR_CFC.mean <- round(mean(rmse.SVMR_CFC.vector), digits = 2) #0.52
...
RMSE.SVMR_CFC2 <- RMSE(dfB2_CFC$CFC,pred_SVMR_CFC2) #RMSE =1.33
...
RMSE.SVMP_CFC1 <- RMSE(test_cfc2$CFC,pred_SVMP_CFC1) #RMSE =0.69
...
# find the 95% confidence intervals parameters
ci.SVMP_CFC <- CI(rmse.SVMP_CFC.vector, ci = 0.95) # 0.61, 0.58, 0.56  
# rmse mean
rmse.SVMP_CFC.mean <- round(mean(rmse.SVMP_CFC.vector), digits = 2) #0.58
...
RMSE.SVMP_CFC2 <- RMSE(dfB2_CFC$CFC,pred_SVMP_CFC2) #RMSE =14.93
...
RMSE.lm_CFC1 <- RMSE(test_cfc2$CFC,pred_lm_CFC1) #RMSE =0.59
...
# find the 95% confidence intervals parameters
ci.lm_CFC <- CI(rmse.lm_CFC.vector, ci = 0.95) #package: Rmisc #0.62, 0.6, 0.58
# rmse mean
rmse.lm_CFC.mean <- round(mean(rmse.lm_CFC.vector), digits = 2) #0.6
...
RMSE.lm_CFC2 <- RMSE(dfB2_CFC$CFC,pred_lm_CFC2) #RMSE =24.69
...
saveRDS(predictors_staa_toSave, "./models/CB/FTIR/predictors_RF_SVMR_BRO.rds") #save model as an rds object
...
RMSE.Rf_STAA1 <- RMSE(test_staa2$STAA,pred_Rf_STAA1) #RMSE =0.62
...
# rf plot predicted vs Observed
plot(pred_Rf_STAA1,test_staa2$STAA,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Brochothrix thermosphacta counts/g",
     ylab="Actual log10 Brochothrix thermosphacta counts/g",col = "blue", 
     main=paste("Random Forest model for Brochothrix thermosphacta counts \nRMSE:",
                round(RMSE.Rf_STAA1,digits = 2), 
                "\nAccuracy",accuracy_Rf_STAA,"% - at ±1 LogCount"))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
...
# compute the standard deviation
sd.Rf_STAA <- round(sd(rmse.Rf_STAA.vector), digits = 2) #0.09
# find the 95% confidence intervals parameters
ci.Rf_STAA <- CI(rmse.Rf_STAA.vector, ci = 0.95) #package: Rmisc #0.58, 0.55, 0.53
# rmse mean
rmse.Rf_STAA.mean <- round(mean(rmse.Rf_STAA.vector), digits = 2) #0.55
...
RMSE.Rf_STAA2 <- RMSE(dfB2_STAA$STAA,pred_Rf_STAA2) #RMSE =2.43

# rf plot predicted vs Observed
plot(pred_Rf_STAA2,dfB2_STAA$STAA,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Brochothrix thermosphacta counts/g",
     ylab="Actual log10 Brochothrix thermosphacta counts/g",col = "blue", 
     main=paste("Random Forest model for Brochothrix thermosphacta counts \nRMSE:",round(RMSE.Rf_STAA2,digits = 2)))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
...
RMSE.knn_STAA1 <- RMSE(test_staa2$STAA,pred_knn_STAA1) #RMSE =0.79
...
# find the 95% confidence intervals parameters
ci.knn_STAA <- CI(rmse.knn_STAA.vector, ci = 0.95) # 0.73, 0.69, 0.66
# rmse mean
rmse.knn_STAA.mean <- round(mean(rmse.knn_STAA.vector), digits = 2) #0.69
...
RMSE.knn_STAA2 <- RMSE(dfB2_STAA$STAA,pred_knn_STAA2) #RMSE =1.45
...
RMSE.SVMLM_STAA1 <- RMSE(test_staa2$STAA,pred_SVMLM_STAA1) #RMSE =0.78
...
# compute the standard deviation
sd.SVMLM_STAA <- round(sd(rmse.SVMLM_STAA.vector), digits = 2) #0.07
# find the 95% confidence intervals parameters
ci.SVMLM_STAA <- CI(rmse.SVMLM_STAA.vector, ci = 0.95) # 0.72, 0.7, 0.68   
# rmse mean
rmse.SVMLM_STAA.mean <- round(mean(rmse.SVMLM_STAA.vector), digits = 2) #0.7
...
RMSE.SVMLM_STAA2 <- RMSE(dfB2_STAA$STAA,pred_SVMLM_STAA2) #RMSE =22.81
...
RMSE.SVMR_STAA1 <- RMSE(test_staa2$STAA,pred_SVMR_STAA1) #RMSE =0.56
...
# find the 95% confidence intervals parameters
ci.SVMR_STAA <- CI(rmse.SVMR_STAA.vector, ci = 0.95) # 0.54, 0.51, 0.49
# rmse mean
...
RMSE.SVMR_STAA2 <- RMSE(dfB2_STAA$STAA,pred_SVMR_STAA2) #RMSE =1.2
...
RMSE.SVMP_STAA1 <- RMSE(test_staa2$STAA,pred_SVMP_STAA1) #RMSE =1.64
...
# compute the standard deviation
sd.SVMP_STAA <- round(sd(rmse.SVMP_STAA.vector), digits = 2) #1.08
# find the 95% confidence intervals parameters
ci.SVMP_STAA <- CI(rmse.SVMP_STAA.vector, ci = 0.95) #1.3, 1, 0.68
# rmse mean
rmse.SVMP_STAA.mean <- round(mean(rmse.SVMP_STAA.vector), digits = 2) #1
...
RMSE.SVMP_STAA2 <- RMSE(dfB2_STAA$STAA,pred_SVMP_STAA2) #RMSE =5.22
...
RMSE.lm_STAA1 <- RMSE(test_staa2$STAA,pred_lm_STAA1) #RMSE =0.73
...
# find the 95% confidence intervals parameters
ci.lm_STAA <- CI(rmse.lm_STAA.vector, ci = 0.95) #package: Rmisc #0.71, 0.69, 0.67
# rmse mean
rmse.lm_STAA.mean <- round(mean(rmse.lm_STAA.vector), digits = 2) #0.69
...
RMSE.lm_STAA2 <- RMSE(dfB2_STAA$STAA,pred_lm_STAA2) #RMSE =14.97
...
saveRDS(predictors_mrs_toSave, "./models/CB/FTIR/predictors_knn_RF_SVML_LM_LAB.rds") #save model as an rds object
...
RMSE.Rf_MRS1 <- RMSE(test_mrs2$MRS,pred_Rf_MRS1) #RMSE =0.63
...
# rf plot predicted vs Observed
plot(pred_Rf_MRS1,test_mrs2$MRS,xlim= c(0,10), ylim=c(0,10),xlab="Predcted log10 LAB counts/g",
     ylab="Actual log10 LAB counts/g",col = "blue", 
     main=paste("Random Forest model for Lactic Acid Bacteria (LAB) counts \nRMSE:",
                round(RMSE.Rf_MRS1,digits = 2), 
                "\nAccuracy",accuracy_Rf_MRS,"% - at ±1 LogCount"))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
...
# compute the standard deviation
sd.Rf_MRS <- round(sd(rmse.Rf_MRS.vector), digits = 2) #0.09
# find the 95% confidence intervals parameters
ci.Rf_MRS <- CI(rmse.Rf_MRS.vector, ci = 0.95) #package: Rmisc #0.71, 0.68, 0.66
# rmse mean
rmse.Rf_MRS.mean <- round(mean(rmse.Rf_MRS.vector), digits = 2) #0.68
...
RMSE.Rf_MRS2 <- RMSE(dfB2_MRS$MRS,pred_Rf_MRS2) #RMSE =1.82

# rf plot predicted vs Observed
plot(pred_Rf_MRS2,dfB2_MRS$MRS,xlim= c(0,10), ylim=c(0,10),xlab="Predcted log10 LAB counts/g",
     ylab="Actual log10 LAB counts/g",col = "blue", 
     main=paste("Random Forest model for Lactic Acid Bacteria (LAB) counts \nRMSE:",
                round(RMSE.Rf_MRS2,digits = 2)))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
...
###################
# trained based on B, tested based on A
model_Rf_MRS3 <- train(MRS ~ ., data = dfB2_MRS_B,
                        method = "rf", trControl = fitControl)
pred_Rf_MRS3<- predict(model_Rf_MRS3,dfA2_MRS_B)
RMSE.Rf_MRS3 <- RMSE(dfA2_MRS_B$MRS,pred_Rf_MRS3) 

# plot predicted vs Observed
plot(pred_Rf_MRS3,dfA2_MRS_B$MRS,xlim= c(0,10), ylim=c(0,10),xlab="Predcted log10 LAB counts/g",
     ylab="Actual log10 LAB counts/g",col = "blue", 
     main=paste("Random Forest model for Lactic Acid Bacteria (LAB) counts \nRMSE:",
                round(RMSE.Rf_MRS3,digits = 2)))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
...
##################
# trained and tested based on batch A
model_Rf_MRS4 <- train(MRS ~ ., data = trainA_mrs1,
                        method = "rf", trControl = fitControl)
pred_Rf_MRS4<- predict(model_Rf_MRS4,testA_mrs1)
RMSE.Rf_MRS4 <- RMSE(testA_mrs1$MRS,pred_Rf_MRS4) 

# predicted vs Observed
plot(pred_Rf_MRS4,testA_mrs1$MRS,xlim= c(0,10), ylim=c(0,10),xlab="Predcted log10 LAB counts/g",
     ylab="Actual log10 LAB counts/g",col = "blue", 
     main=paste("Random Forest model for Lactic Acid Bacteria (LAB) counts \nRMSE:",
                round(RMSE.Rf_MRS4,digits = 2)))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
...
#######################
# trained and tested based on batch B
model_Rf_MRS5 <- train(MRS ~ ., data = trainB_mrs1,
                        method = "rf", trControl = fitControl)
pred_Rf_MRS5<- predict(model_Rf_MRS5,testB_mrs1)
RMSE.Rf_MRS5 <- RMSE(testB_mrs1$MRS,pred_Rf_MRS5) 

# predicted vs Observed
plot(pred_Rf_MRS5,testB_mrs1$MRS,xlim= c(0,10), ylim=c(0,10),xlab="Predcted log10 LAB counts/g",
     ylab="Actual log10 LAB counts/g",col = "blue", 
     main=paste("Random Forest model for Lactic Acid Bacteria (LAB) counts \nRMSE:",
                round(RMSE.Rf_MRS5,digits = 2)))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
...
RMSE.knn_MRS1 <- RMSE(test_mrs2$MRS,pred_knn_MRS1) #RMSE =0.79
...
# find the 95% confidence intervals parameters
ci.knn_MRS <- CI(rmse.knn_MRS.vector, ci = 0.95) # 0.81, 0.78, 0.75
# rmse mean
rmse.knn_MRS.mean <- round(mean(rmse.knn_MRS.vector), digits = 2) #0.78
...
RMSE.knn_MRS2 <- RMSE(dfB2_MRS$MRS,pred_knn_MRS2) #RMSE =2.56
...
RMSE.SVMLM_MRS1 <- RMSE(test_mrs2$MRS,pred_SVMLM_MRS1) #RMSE =0.71
...
# compute the standard deviation
sd.SVMLM_MRS <- round(sd(rmse.SVMLM_MRS.vector), digits = 2) #0.12
# find the 95% confidence intervals parameters
ci.SVMLM_MRS <- CI(rmse.SVMLM_MRS.vector, ci = 0.95) # 0.79, 0.76, 0.72 
# rmse mean
rmse.SVMLM_MRS.mean <- round(mean(rmse.SVMLM_MRS.vector), digits = 2) #0.76
...
RMSE.SVMLM_MRS2 <- RMSE(dfB2_MRS$MRS,pred_SVMLM_MRS2) #RMSE =45.82
...
RMSE.SVMR_MRS1 <- RMSE(test_mrs2$MRS,pred_SVMR_MRS1) #RMSE =0.65
...
# compute the standard deviation
sd.SVMR_MRS <- round(sd(rmse.SVMR_MRS.vector), digits = 2) #0.09
# find the 95% confidence intervals parameters
ci.SVMR_MRS <- CI(rmse.SVMR_MRS.vector, ci = 0.95) # 0.66, 0.64, 0.61   
# rmse mean
...
RMSE.SVMR_MRS2 <- RMSE(dfB2_MRS$MRS,pred_SVMR_MRS2) #RMSE =1.83
...
RMSE.SVMP_MRS1 <- RMSE(test_mrs2$MRS,pred_SVMP_MRS1) #RMSE =0.75
...
# compute the standard deviation
sd.SVMP_MRS <- round(sd(rmse.SVMP_MRS.vector), digits = 2) #1.13
# find the 95% confidence intervals parameters
ci.SVMP_MRS <- CI(rmse.SVMP_MRS.vector, ci = 0.95) # 1.64, 1.31, 0.99
# rmse mean
rmse.SVMP_MRS.mean <- round(mean(rmse.SVMP_MRS.vector), digits = 2) #1.31
...
RMSE.SVMP_MRS2 <- RMSE(dfB2_MRS$MRS,pred_SVMP_MRS2) #RMSE =83.78
...
RMSE.lm_MRS1 <- RMSE(test_mrs2$MRS,pred_lm_MRS1) #RMSE =0.7
...
# compute the standard deviation
sd.lm_MRS <- round(sd(rmse.lm_MRS.vector), digits = 2) #0.09
# find the 95% confidence intervals parameters
ci.lm_MRS <- CI(rmse.lm_MRS.vector, ci = 0.95) #package: Rmisc #0.74, 0.72, 0.69
# rmse mean
rmse.lm_MRS.mean <- round(mean(rmse.lm_MRS.vector), digits = 2) #0.72
...
RMSE.lm_MRS2 <- RMSE(dfB2_MRS$MRS,pred_lm_MRS2) #RMSE =46.46
